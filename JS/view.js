        ...
        switch(pageID) {
            ...
            case "#home": /* HOME PAGE */
                $('button.pickplayer').on('click', function() {
                    ...
                    setLocalStorage("playerName", player); // pass player to game
            ...
            case "#page1": /* PAGE 1 */
                ...
                $('button.pg1ch1').on('click', function() {
                    setLocalStorage("pg1ch1", gameChallenge("pg1ch1")); // pass player to game
                    window.location.href = 'game.html#page2';
                    location.reload();
                });
                $('button.pg1ch2').on('click', function() {
                    setLocalStorage("pg1ch2", gameChallenge("pg1ch2")); // pass player to game
                    window.location.href = 'game.html#page2';
                    location.reload();
                });
                break;
